...
public interface UpdateInterface {
	...
	/** public WriteResponse updateBlockCausal(long mbId, Metadata mbMetadata, ByteBuffer mbData,
			SessionLog sessionLogInstance, String clientId, PutPreference putpref, Fog fog); **/
}
