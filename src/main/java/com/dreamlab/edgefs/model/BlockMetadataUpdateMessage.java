...
public enum BlockMetadataUpdateMessage {
	...
	FAIL_NULL_METADATA("Null metadata not allowed", (byte) -5),
	FAIL_NOT_EXISTS("The fog doesn't have the stream", (byte) -4),
	FAIL_NOT_OWNER("Update can happen only at the Fog where the stream was created", (byte) -3),
	...
	FAIL_NO_LOCK("Block writes are allowed only when holding the stream lock", (byte) -2),
	...
	FAIL_LEASE_EXPIRED("Lease expired but renew can happen", (byte) -1),
