...
public class FindReplica implements org.apache.thrift.TBase<FindReplica, FindReplica._Fields>, java.io.Serializable, Cloneable, Comparable<FindReplica> {
  ...
  private static final org.apache.thrift.protocol.TField IS_LOCAL_FIELD_DESC = new org.apache.thrift.protocol.TField("isLocal", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  private static final _Fields optionals[] = {_Fields.NODE,_Fields.EDGE_INFO,_Fields.IS_LOCAL};
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_LOCAL, new org.apache.thrift.meta_data.FieldMetaData("isLocal", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public FindReplica setIsLocal(boolean isLocal) {
  ...
  public boolean equals(FindReplica that) {
    ...
    boolean this_present_isLocal = true && this.isSetIsLocal();
    boolean that_present_isLocal = true && that.isSetIsLocal();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIsLocal()) ? 131071 : 524287);
    if (isSetIsLocal())
