...
public class ByteTypeStreamMetadata implements org.apache.thrift.TBase<ByteTypeStreamMetadata, ByteTypeStreamMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<ByteTypeStreamMetadata> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ByteTypeStreamMetadata");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ByteTypeStreamMetadataStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ByteTypeStreamMetadataTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ByteTypeStreamMetadata.class, metaDataMap);
  }

  public ByteTypeStreamMetadata() {
  }
   ...
   */
  public ByteTypeStreamMetadata(ByteTypeStreamMetadata other) {
    __isset_bitfield = other.__isset_bitfield;
    this.value = other.value;
    this.updatable = other.updatable;
  }

  public ByteTypeStreamMetadata deepCopy() {
    return new ByteTypeStreamMetadata(this);
  }
  ...
  public ByteTypeStreamMetadata setValue(byte value) {
    this.value = value;
    setValueIsSet(true);
    return this;
  }
  ...
  public ByteTypeStreamMetadata setUpdatable(boolean updatable) {
    this.updatable = updatable;
    setUpdatableIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof ByteTypeStreamMetadata)
      return this.equals((ByteTypeStreamMetadata)that);
    return false;
  }

  public boolean equals(ByteTypeStreamMetadata that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(ByteTypeStreamMetadata other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ByteTypeStreamMetadata(");
    boolean first = true;
  ...
  private static class ByteTypeStreamMetadataStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ByteTypeStreamMetadataStandardScheme getScheme() {
      return new ByteTypeStreamMetadataStandardScheme();
    }
  }

  private static class ByteTypeStreamMetadataStandardScheme extends org.apache.thrift.scheme.StandardScheme<ByteTypeStreamMetadata> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ByteTypeStreamMetadata struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ByteTypeStreamMetadata struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ByteTypeStreamMetadataTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ByteTypeStreamMetadataTupleScheme getScheme() {
      return new ByteTypeStreamMetadataTupleScheme();
    }
  }

  private static class ByteTypeStreamMetadataTupleScheme extends org.apache.thrift.scheme.TupleScheme<ByteTypeStreamMetadata> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ByteTypeStreamMetadata struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ByteTypeStreamMetadata struct) throws org.apache.thrift.TException {
