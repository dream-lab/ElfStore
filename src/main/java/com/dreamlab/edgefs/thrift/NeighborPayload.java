...
public class NeighborPayload implements org.apache.thrift.TBase<NeighborPayload, NeighborPayload._Fields>, java.io.Serializable, Cloneable, Comparable<NeighborPayload> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("NeighborPayload");
  ...
  private static final org.apache.thrift.protocol.TField DYNAMIC_BFILTER_FIELD_DESC = new org.apache.thrift.protocol.TField("dynamicBFilter", org.apache.thrift.protocol.TType.STRING, (short)3);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new NeighborPayloadStandardSchemeFactory();
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // DYNAMIC_BFILTER
          return DYNAMIC_BFILTER;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.MB_ID_TO_STREAM_ID_MAP,_Fields.DYNAMIC_BFILTER};
  ...
  static {
    ...
    tmpMap.put(_Fields.DYNAMIC_BFILTER, new org.apache.thrift.meta_data.FieldMetaData("dynamicBFilter", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , true)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(NeighborPayload.class, metaDataMap);
  }

  public NeighborPayload() {
  }
   ...
   */
  public NeighborPayload(NeighborPayload other) {
    ...
    if (other.isSetDynamicBFilter()) {
      this.dynamicBFilter = org.apache.thrift.TBaseHelper.copyBinary(other.dynamicBFilter);
    }
  }

  public NeighborPayload deepCopy() {
    return new NeighborPayload(this);
  }
  ...
  public NeighborPayload setPayload(byte[] payload) {
    this.payload = payload == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(payload.clone());
    return this;
  }

  public NeighborPayload setPayload(java.nio.ByteBuffer payload) {
    this.payload = org.apache.thrift.TBaseHelper.copyBinary(payload);
    return this;
  }
  ...
  public byte[] getDynamicBFilter() {
    setDynamicBFilter(org.apache.thrift.TBaseHelper.rightSize(dynamicBFilter));
    return dynamicBFilter == null ? null : dynamicBFilter.array();
  }

  public java.nio.ByteBuffer bufferForDynamicBFilter() {
    return org.apache.thrift.TBaseHelper.copyBinary(dynamicBFilter);
  }

  public NeighborPayload setDynamicBFilter(byte[] dynamicBFilter) {
    this.dynamicBFilter = dynamicBFilter == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(dynamicBFilter.clone());
    return this;
  }

  public NeighborPayload setDynamicBFilter(java.nio.ByteBuffer dynamicBFilter) {
    this.dynamicBFilter = org.apache.thrift.TBaseHelper.copyBinary(dynamicBFilter);
    return this;
  }

  public void unsetDynamicBFilter() {
    this.dynamicBFilter = null;
  }

  /** Returns true if field dynamicBFilter is set (has been assigned a value) and false otherwise */
  public boolean isSetDynamicBFilter() {
    return this.dynamicBFilter != null;
  }

  public void setDynamicBFilterIsSet(boolean value) {
    if (!value) {
      this.dynamicBFilter = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case DYNAMIC_BFILTER:
      if (value == null) {
        unsetDynamicBFilter();
      } else {
        if (value instanceof byte[]) {
          setDynamicBFilter((byte[])value);
        } else {
          setDynamicBFilter((java.nio.ByteBuffer)value);
        }
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof NeighborPayload)
      return this.equals((NeighborPayload)that);
    return false;
  }

  public boolean equals(NeighborPayload that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_dynamicBFilter = true && this.isSetDynamicBFilter();
    boolean that_present_dynamicBFilter = true && that.isSetDynamicBFilter();
    if (this_present_dynamicBFilter || that_present_dynamicBFilter) {
      if (!(this_present_dynamicBFilter && that_present_dynamicBFilter))
        return false;
      if (!this.dynamicBFilter.equals(that.dynamicBFilter))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetDynamicBFilter()) ? 131071 : 524287);
    if (isSetDynamicBFilter())
      hashCode = hashCode * 8191 + dynamicBFilter.hashCode();

    return hashCode;
  }

  @Override
  public int compareTo(NeighborPayload other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDynamicBFilter()).compareTo(other.isSetDynamicBFilter());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDynamicBFilter()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dynamicBFilter, other.dynamicBFilter);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("NeighborPayload(");
    boolean first = true;
    ...
    if (isSetDynamicBFilter()) {
      if (!first) sb.append(", ");
      sb.append("dynamicBFilter:");
      if (this.dynamicBFilter == null) {
        sb.append("null");
      } else {
        org.apache.thrift.TBaseHelper.toString(this.dynamicBFilter, sb);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class NeighborPayloadStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public NeighborPayloadStandardScheme getScheme() {
      return new NeighborPayloadStandardScheme();
    }
  }

  private static class NeighborPayloadStandardScheme extends org.apache.thrift.scheme.StandardScheme<NeighborPayload> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NeighborPayload struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // DYNAMIC_BFILTER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.dynamicBFilter = iprot.readBinary();
              struct.setDynamicBFilterIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NeighborPayload struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.dynamicBFilter != null) {
        if (struct.isSetDynamicBFilter()) {
          oprot.writeFieldBegin(DYNAMIC_BFILTER_FIELD_DESC);
          oprot.writeBinary(struct.dynamicBFilter);
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class NeighborPayloadTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public NeighborPayloadTupleScheme getScheme() {
      return new NeighborPayloadTupleScheme();
    }
  }

  private static class NeighborPayloadTupleScheme extends org.apache.thrift.scheme.TupleScheme<NeighborPayload> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NeighborPayload struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NeighborPayload struct) throws org.apache.thrift.TException {
