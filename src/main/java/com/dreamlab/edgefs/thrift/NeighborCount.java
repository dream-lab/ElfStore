...
public class NeighborCount implements org.apache.thrift.TBase<NeighborCount, NeighborCount._Fields>, java.io.Serializable, Cloneable, Comparable<NeighborCount> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.neighborCountPerPool = new java.util.HashMap<java.lang.Short,java.lang.Short>(2*_map18.size);
                short _key19;
                short _val20;
                for (int _i21 = 0; _i21 < _map18.size; ++_i21)
                {
                  ...
                  struct.neighborCountPerPool.put(_key19, _val20);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.neighborCountPerPool != null) {
        if (struct.isSetNeighborCountPerPool()) {
          oprot.writeFieldBegin(NEIGHBOR_COUNT_PER_POOL_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Short, java.lang.Short> _iter22 : struct.neighborCountPerPool.entrySet())
            {
              oprot.writeI16(_iter22.getKey());
              oprot.writeI16(_iter22.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class NeighborCountTupleScheme extends org.apache.thrift.scheme.TupleScheme<NeighborCount> {
      ...
      if (struct.isSetNeighborCountPerPool()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Short, java.lang.Short> _iter23 : struct.neighborCountPerPool.entrySet())
          {
            oprot.writeI16(_iter23.getKey());
            oprot.writeI16(_iter23.getValue());
          }
        }
      }
      if (struct.isSetNodeInfoData()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NeighborCount struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map24 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I16, org.apache.thrift.protocol.TType.I16, iprot.readI32());
          struct.neighborCountPerPool = new java.util.HashMap<java.lang.Short,java.lang.Short>(2*_map24.size);
          short _key25;
          short _val26;
          for (int _i27 = 0; _i27 < _map24.size; ++_i27)
          {
            _key25 = iprot.readI16();
            _val26 = iprot.readI16();
            struct.neighborCountPerPool.put(_key25, _val26);
          }
        }
        struct.setNeighborCountPerPoolIsSet(true);
      }
