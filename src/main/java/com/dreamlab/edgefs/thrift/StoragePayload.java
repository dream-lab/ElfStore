...
public class StoragePayload implements org.apache.thrift.TBase<StoragePayload, StoragePayload._Fields>, java.io.Serializable, Cloneable, Comparable<StoragePayload> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StoragePayload");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new StoragePayloadStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new StoragePayloadTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StoragePayload.class, metaDataMap);
  }
   ...
   */
  public StoragePayload(StoragePayload other) {
  ...
  public StoragePayload deepCopy() {
    return new StoragePayload(this);
  }
  ...
  public StoragePayload setEdgeId(short edgeId) {
    this.edgeId = edgeId;
    setEdgeIdIsSet(true);
    return this;
  }
  ...
  public StoragePayload setEncodedStorage(byte encodedStorage) {
  ...
  public StoragePayload setReliability(byte reliability) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof StoragePayload)
      return this.equals((StoragePayload)that);
    return false;
  }

  public boolean equals(StoragePayload that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(StoragePayload other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("StoragePayload(");
    boolean first = true;
  ...
  private static class StoragePayloadStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public StoragePayloadStandardScheme getScheme() {
      return new StoragePayloadStandardScheme();
    }
  }

  private static class StoragePayloadStandardScheme extends org.apache.thrift.scheme.StandardScheme<StoragePayload> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StoragePayload struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StoragePayload struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class StoragePayloadTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public StoragePayloadTupleScheme getScheme() {
      return new StoragePayloadTupleScheme();
    }
  }

  private static class StoragePayloadTupleScheme extends org.apache.thrift.scheme.TupleScheme<StoragePayload> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StoragePayload struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StoragePayload struct) throws org.apache.thrift.TException {
