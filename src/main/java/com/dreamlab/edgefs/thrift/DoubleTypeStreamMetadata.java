...
public class DoubleTypeStreamMetadata implements org.apache.thrift.TBase<DoubleTypeStreamMetadata, DoubleTypeStreamMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<DoubleTypeStreamMetadata> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DoubleTypeStreamMetadata");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DoubleTypeStreamMetadataStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DoubleTypeStreamMetadataTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DoubleTypeStreamMetadata.class, metaDataMap);
  }

  public DoubleTypeStreamMetadata() {
  }
   ...
   */
  public DoubleTypeStreamMetadata(DoubleTypeStreamMetadata other) {
    __isset_bitfield = other.__isset_bitfield;
    this.value = other.value;
    this.updatable = other.updatable;
  }

  public DoubleTypeStreamMetadata deepCopy() {
    return new DoubleTypeStreamMetadata(this);
  }
  ...
  public DoubleTypeStreamMetadata setValue(double value) {
    this.value = value;
    setValueIsSet(true);
    return this;
  }
  ...
  public DoubleTypeStreamMetadata setUpdatable(boolean updatable) {
    this.updatable = updatable;
    setUpdatableIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof DoubleTypeStreamMetadata)
      return this.equals((DoubleTypeStreamMetadata)that);
    return false;
  }

  public boolean equals(DoubleTypeStreamMetadata that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(DoubleTypeStreamMetadata other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DoubleTypeStreamMetadata(");
    boolean first = true;
  ...
  private static class DoubleTypeStreamMetadataStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DoubleTypeStreamMetadataStandardScheme getScheme() {
      return new DoubleTypeStreamMetadataStandardScheme();
    }
  }

  private static class DoubleTypeStreamMetadataStandardScheme extends org.apache.thrift.scheme.StandardScheme<DoubleTypeStreamMetadata> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DoubleTypeStreamMetadata struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DoubleTypeStreamMetadata struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DoubleTypeStreamMetadataTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DoubleTypeStreamMetadataTupleScheme getScheme() {
      return new DoubleTypeStreamMetadataTupleScheme();
    }
  }

  private static class DoubleTypeStreamMetadataTupleScheme extends org.apache.thrift.scheme.TupleScheme<DoubleTypeStreamMetadata> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DoubleTypeStreamMetadata struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DoubleTypeStreamMetadata struct) throws org.apache.thrift.TException {
