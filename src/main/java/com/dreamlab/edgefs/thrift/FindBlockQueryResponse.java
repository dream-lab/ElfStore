            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.findBlockQueryResultMap = new java.util.HashMap<java.lang.Long,FindBlockQueryValue>(2*_map120.size);
                long _key121;
                FindBlockQueryValue _val122;
                for (int _i123 = 0; _i123 < _map120.size; ++_i123)
                {
                  _key121 = iprot.readI64();
                  _val122 = new FindBlockQueryValue();
                  _val122.read(iprot);
                  struct.findBlockQueryResultMap.put(_key121, _val122);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindBlockQueryResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.findBlockQueryResultMap != null) {
        oprot.writeFieldBegin(FIND_BLOCK_QUERY_RESULT_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, FindBlockQueryValue> _iter124 : struct.findBlockQueryResultMap.entrySet())
          {
            oprot.writeI64(_iter124.getKey());
  ...
  private static class FindBlockQueryResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<FindBlockQueryResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, FindBlockQueryResponse struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.Long, FindBlockQueryValue> _iter125 : struct.findBlockQueryResultMap.entrySet())
        {
          oprot.writeI64(_iter125.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, FindBlockQueryResponse struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map126 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.findBlockQueryResultMap = new java.util.HashMap<java.lang.Long,FindBlockQueryValue>(2*_map126.size);
        long _key127;
        FindBlockQueryValue _val128;
        for (int _i129 = 0; _i129 < _map126.size; ++_i129)
        {
          _key127 = iprot.readI64();
          _val128 = new FindBlockQueryValue();
          _val128.read(iprot);
          struct.findBlockQueryResultMap.put(_key127, _val128);
        }
      }
      struct.setFindBlockQueryResultMapIsSet(true);
      struct.status = iprot.readByte();
