            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new java.util.ArrayList<java.nio.ByteBuffer>(_list84.size);
                java.nio.ByteBuffer _elem85;
                for (int _i86 = 0; _i86 < _list84.size; ++_i86)
                {
                  _elem85 = iprot.readBinary();
                  struct.data.add(_elem85);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (java.nio.ByteBuffer _iter87 : struct.data)
            {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (java.nio.ByteBuffer _iter88 : struct.data)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.data = new java.util.ArrayList<java.nio.ByteBuffer>(_list89.size);
