            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new java.util.ArrayList<java.nio.ByteBuffer>(_list46.size);
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (java.nio.ByteBuffer _iter49 : struct.data)
            {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (java.nio.ByteBuffer _iter50 : struct.data)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.data = new java.util.ArrayList<java.nio.ByteBuffer>(_list51.size);
          java.nio.ByteBuffer _elem52;
          for (int _i53 = 0; _i53 < _list51.size; ++_i53)
          {
            _elem52 = iprot.readBinary();
            struct.data.add(_elem52);
          }
        }
        struct.setDataIsSet(true);
      }
